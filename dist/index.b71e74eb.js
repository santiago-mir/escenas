...
var _inbox = require("./components/inbox/inbox");
var _sent = require("./components/sent/sent");
...
function handleRoute(route) {
    const routes = [
        {
            path: /\/inbox/,
            handler: ()=>(0, _inbox.initInbox)(container)
        },
        {
            path: /\/sent/,
            handler: ()=>(0, _sent.initSent)(container)
        }, 
    ];
...
},{"./components/inbox/inbox":"fobdt","./components/sent/sent":"kYYgB"}],"fobdt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initInbox", ()=>initInbox);
function initInbox(container) {
...
},{}],"kYYgB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initSent", ()=>initSent);
function initSent(container) {
    const div = document.createElement("div");
    div.innerHTML = `
